  ...
  return (
    <>
      ...
      <section className="section-padding bg-white">
        <div className="container-lg max-w-3xl">
          ...
          <p className="mb-8 text-slate-600 leading-relaxed">
            Want to understand how transponder technology works? Read our plain-English guide:{' '}
            <Link href="/guides/what-is-a-transponder-key" className="font-semibold text-brand-600 hover:underline">
      ...
      <section className="section-padding bg-slate-50">
        <div className="container-lg">
          <h2 className="mb-2 text-xl font-bold text-slate-900">Car Key Programming — Areas We Cover</h2>
          <p className="mb-5 text-sm text-slate-500">
            We programme transponder keys and remote fobs across Leicester and all surrounding Leicestershire towns. Select your area for local service details.
          </p>
